The Number Game required me to use my knowledge of Java Programming to create a game that generates a random number and allows the user to guess it within a certain number of tries.
